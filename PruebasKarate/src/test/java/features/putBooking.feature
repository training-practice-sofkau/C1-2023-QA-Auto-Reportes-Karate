Feature: Update Book
  ...
  I want to update an existing book's information
  ...
  @Token
  @UpdateBooking
  Scenario: not Update an existing book's information in Restfull Booker if the user doesn't have the token
